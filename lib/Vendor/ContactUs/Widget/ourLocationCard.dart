...
class _OurLocationCardState extends State<OurLocationCard> {
  ...
  final Set<Marker> _markers = {
    const Marker(markerId: MarkerId('spare_parts'), position: LatLng(-37.8014, 144.9797)),
    const Marker(markerId: MarkerId('rental_showroom'), position: LatLng(-37.8140, 144.9660)),
    const Marker(markerId: MarkerId('head_office'), position: LatLng(-37.8073, 144.9912)),
  };
            ...
            children: [
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      "Visit our office for bookings and assistance. Our team is ready to help you with all your car rental needs.",
              ...
              SizedBox(
                ...
                child: GoogleMap(
                  ...
                  zoomControlsEnabled: !isUltraSmall,
                ),
              ),
