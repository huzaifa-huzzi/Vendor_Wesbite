...
class DetailTroubleShootingGuide extends StatelessWidget {
  const DetailTroubleShootingGuide({super.key});
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            image: AssetImage(controller.dynamicTroubleBackgroundImage),
            fit: BoxFit.cover,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Flexible(
                child: Text(
                  controller.dynamicTroubleTitle2,
                ...
                children: [
                  ...
                  _buildBreadcrumbItem(
                    ...
                    onTap: () {
                      ...
                      controller.resetTroubleToDashboard();
                    },
                  ),
                  _buildSeparator(context),
                  _buildBreadcrumbItem(
                    context,
                    label: TextString.troubleShootingTitle,
                    onTap: controller.isTroubleSubViewDetail
                        ? () => controller.resetTroubleToDashboard()
                        : null,
                  ),
                  if (controller.isTroubleSubViewDetail) ...[
                    _buildSeparator(context),
                    _buildBreadcrumbItem(
                      context,
