...
class DetailPricingGuide extends StatelessWidget {
  const DetailPricingGuide({super.key});
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            image: AssetImage(controller.dynamicPricingBackgroundImage),
            fit: BoxFit.cover,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Flexible(
                child: Text(
                  controller.dynamicPricingTitle2,
              ...
              Wrap(
                ...
                children: [
                  ...
                  if (controller.isPricingSubViewDetail) ...[
                    _buildSeparator(context),
                    _buildBreadcrumbItem(
                      context,
