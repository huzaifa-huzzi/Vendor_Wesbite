...
class DetailDocumentGuide extends StatelessWidget {
  const DetailDocumentGuide({super.key});
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            image: AssetImage(controller.dynamicDocumentBackgroundImage),
            fit: BoxFit.cover,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Flexible(
                child: Text(
                  controller.dynamicDocumentTitle,
              ...
              Wrap(
                ...
                children: [
                  ...
                  if (controller.isDocumentSubViewDetail) ...[
                    _buildSeparator(context),
                    _buildBreadcrumbItem(
                      context,
