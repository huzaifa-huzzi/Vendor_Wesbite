...
import 'package:vendor_website/Vendor/FooterSection/HelpCenter/Pickup/Widget/DetailGuidePickup.dart';
import 'package:vendor_website/Vendor/FooterSection/HelpCenter/Pickup/Widget/GettingStartedPickup.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            DetailLogisticsGuide(),
            SizedBox(height: 80,),
            GettingStartedPickup(),
            SizedBox(height: 50,),
            ContactHelpCard(),
            SizedBox(height: 100,),
