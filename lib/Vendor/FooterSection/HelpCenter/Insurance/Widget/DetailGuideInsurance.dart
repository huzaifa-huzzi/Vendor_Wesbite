...
class DetailInsuranceGuide extends StatelessWidget {
  const DetailInsuranceGuide({super.key});
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          image: DecorationImage(
            image: AssetImage(controller.dynamicInsuranceBackgroundImage),
            fit: BoxFit.cover,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Flexible(
                child: Text(
                  controller.dynamicInsuranceTitle2,
              ...
              Wrap(
                ...
                children: [
                  ...
                  if (controller.isInsuranceSubViewDetail) ...[
                    _buildSeparator(context),
