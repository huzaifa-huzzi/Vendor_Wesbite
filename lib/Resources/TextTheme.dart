...
class TTextTheme {
  ...
  static TextStyle numbering(BuildContext context){
    return _textStyle(fontSize:AppTextSizes.size(context, 28, 30, 32),fontWeight: FontWeight.w600,color: AppColors.primaryColor);
  }
  ...
  static TextStyle hUnderMaintenance(BuildContext context){
    return _textStyle(fontSize:AppTextSizes.size(context, 53, 55, 60),fontWeight: FontWeight.w600,color: AppColors.textColor);
  }
  ...
  static TextStyle h3Style(BuildContext context){
    return _textStyle(fontSize:AppTextSizes.size(context, 22, 24, 26),fontWeight: FontWeight.w600,color: AppColors.textColor);
  }

  static TextStyle h5Style(BuildContext context){
    return _textStyle(fontSize:AppTextSizes.size(context, 21, 22, 24),fontWeight: FontWeight.w600,color: AppColors.textColor);
  }
  ...
  static TextStyle h6StylePrimary(BuildContext context){
    return _textStyle(fontSize:AppTextSizes.size(context, 35, 38, 40),fontWeight: FontWeight.w500,color: AppColors.primaryColor);
  }

  static TextStyle bannerBlack(BuildContext context){
  ...
  static TextStyle h2Styleblack(BuildContext context){
    return _textStyle(fontSize:AppTextSizes.size(context, 20, 22, 24),fontWeight: FontWeight.w600,color: AppColors.blackColor);
  }
  ...
  static TextStyle medium16paragraph(BuildContext context){
    return _textStyle(fontSize:AppTextSizes.size(context, 13, 15, 16),fontWeight: FontWeight.w500,color: AppColors.tertiaryTextColor);
  }
  ...
  static TextStyle hContactServicesSubtitle2(BuildContext context){
    return _textStyle(fontSize:AppTextSizes.size(context, 20, 20, 20),fontWeight: FontWeight.w400,color: AppColors.textColor);
  }
  ...
  static TextStyle bodyRegular16SecondarColor(BuildContext context){
  ...
  static TextStyle bodySemiBold16black(BuildContext context){
    return _textStyle(fontSize:AppTextSizes.size(context, 16, 16, 16),fontWeight: FontWeight.w600,color: AppColors.textColor);
  }
  ...
  static TextStyle tableRegular18(BuildContext context){
    return _textStyle(fontSize:AppTextSizes.size(context, 16, 18, 18),fontWeight: FontWeight.w400,color: AppColors.textColor);
  }
